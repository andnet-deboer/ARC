...
# Force expected env BEFORE any SAM3D imports
os.environ.setdefault("CONDA_PREFIX", "/opt/conda")
os.environ.setdefault("CUDA_HOME", "/usr/local/cuda")

SAM3D_ROOT = "/opt/sam3d"
if SAM3D_ROOT not in sys.path:
    sys.path.insert(0, SAM3D_ROOT)

sys.path.append("/opt/sam3d/notebook")  # make sure Python sees this folder
...
def load_model():
    ...
    if sam3d_model is None:
        ...
        try:
            config_path = "/opt/sam3d/checkpoints/hf/pipeline.yaml"
